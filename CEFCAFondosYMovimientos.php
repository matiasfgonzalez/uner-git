...
<head>
  ...
  <title>Administrador - Fondo CEFCA - Fondos y movimientos</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Fondos y movimientos del Fondo CEFCA</h1>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <div style="display: grid;">
                <a class="btn btn-success" href="agregarNuevoIncidenteCEFCA.php" role="button">
              ...
              <div class="container">
                <?php 
                  $query1= $conexion->prepare("select sum(saldo) as totalEntrada from bdunertest.t_fondosymovimientos_cefca where tipo = 'entrada'");
                  $query2= $conexion->prepare("select sum(saldo) as totalSalida from bdunertest.t_fondosymovimientos_cefca where tipo = 'salida'");
                  $query3= $conexion->prepare("select sum(saldo) as totalES from bdunertest.t_fondosymovimientos_cefca");
                  $query1->execute();
                  $query2->execute();
                  $query3->execute();
                ?>
            ...
            <div class="card-body">
              <div class="table-responsive">
                 <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
                      $query= $conexion->prepare("select * from bdunertest.t_fondosymovimientos_cefca order by id desc");
                      $query->execute();
