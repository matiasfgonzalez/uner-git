...
<head>
  ...
  <title>Peña del estudiante - Fondos y moviemientos - Agregar incidente</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Agregar nuevo incidente en la Peña</h1>
              ...
              <?php } ?>
          <form method="POST" action="agregarNuevoIncidentepeniaBD.php" >
            <div class="form-row">
            ...
            <a class="btn btn-danger" href="peniaFondosYMovimientos.php" role="button">Volver</a>
          </form>
