...
<head>
  ...
  <title>Administrador - Cantina - Productos vendidos</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Productos vendidos en la cantina</h1>
            ...
            <div class="card-body">
              <div class="table-responsive">
                 <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
                      $query= $conexion->prepare("select * from bdunertest.t_productosv where categoria = 'Cantina' ORDER BY t_productosv.fechaDeVendido DESC");
                      $query->execute();
