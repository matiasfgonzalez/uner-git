...
<head>
  ...
  <title>Administrador - Peña del estudiante - Estadisticas</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!--Aca arranca el contenido-->

          <div id="graficos">
          </div>

        
        <!--Aca finaliza el contenido-->
        </div>
        <!-- /.container-fluid -->
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#graficos').load("peniaDelEstudianteEstadisticasGraficos.php");
  });
</script>
<script>
  setInterval(()=>{$( "#graficos" ).load( "peniaDelEstudianteEstadisticasGraficos.php" )},5000)
</script>