...
<head>
  ...
  <title>Administrador - Cantina - Agregar nuevo incidente</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <h1 class="h3 mb-4 text-gray-800">Agregar nuevo incidente en cantina</h1>
              ...
              <?php } ?>
          <form method="POST" action="agregarNuevoIncidenteCantinaBD.php" >
            <div class="form-row">
            ...
            <a class="btn btn-danger" href="cantinaFondosYMovimientos.php" role="button">Volver</a>
          </form>
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Cierre de caja mensual</h1>
          <form method="POST" action="generarCierreDeCajaMensualCantinaBD.php" >
            <div class="form-row">
              <div class="form-group col-md-4">
                <label for="inputEmail4">Mes</label>
                <input type="number" class="form-control" id="inputEmail4" name="mesi" >
              </div>
              <div class="form-group col-md-4">
                <label for="inputEmail4">Año</label>
                <input type="number" class="form-control" id="inputEmail4" name="añoi" >
              </div>
            </div>
