<?php 
  ...
  if(!isset($_SESSION['username'])){
    ...
    if($_POST['codigoDelUsuariom'] != "")
    {
      include_once 'php/conexion.php';
      $bd= new BD();
      $conexion = $bd->connect();
      $codigoDelUsuariom = $_POST['codigoDelUsuariom'];
      $query= $conexion->prepare("select * from bdunertest.t_usuarios where dnicuil = ?");
      $query->bindParam(1, $codigoDelUsuariom, PDO::PARAM_INT);
      $query->execute();
      if($query->rowCount() > 0) 
        {
...
<head>
  ...
  <title>Administrador - Usuarios - Modificar</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid"> 
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Modificar usuario en el sistema</h1>
          <form action="actualizarUsuarioBD.php" method="post">
            <div class="form-row">
              <div class="form-group col-md-5">
                <label for="inputCity">Identificador del usuario</label>
                <input type="text" class="form-control" id="inputCity" name="dnicuil" value="<?php echo $dnicuil?>">
                <input type="hidden" id="custId" name="idDelUsuarioAM" value="<?php echo $id?>">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-4">
                <label for="inputEmail4">Nombre del usuario</label>
                <input type="text" class="form-control" id="inputEmail4" name="nombre" value="<?php echo $nombre?>">
              </div>
              <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="inputPassword4" name="rol_id" value="<?php echo $rol_id?>">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-4">
                ...
                <div class="input-group mb-2">
                  ...
                  <input type="number" class="form-control" id="inputCity" name="telefono" value="<?php echo $telefono?>">
              </div>
              </div>
              <div class="form-group col-md-4">
                <label for="inputCity">Contraseña</label>
                <input type="password" class="form-control" id="inputCity" name="password" value="<?php echo $password?>">
              </div>
              <div class="form-group col-md-4">
                <label for="inputCity">Correo</label>
                <input type="text" class="form-control" id="inputCity" name="correo" value="<?php echo $correo?>">
              </div>
            </div>
