...
<head>
  ...
  <title>Administrador - Peña del estudiante - Entradas</title>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4">
              ...
              <?php } ?>
              <form method="POST" action="peniaDelEstudainteEntradasBD.php">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="inputEmail4" placeholder="" name="codigoDeLaEntrada">
                    </div>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="inputCity">Precio actual: $<?php echo $precio; ?></label>
                    <div class="input-group mb-2">
                      <div class="input-group-prepend">
                        <div class="input-group-text">$</div>
                      </div>
                      <input type="number" class="form-control" id="inputCity" name="precioDeLaEntradaHidden">
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
              <h1 class="h3 mb-2 text-gray-800">Actualizar entradas</h1>
              <?php if(isset($_GET['infov'])){ ?>
                <div class="alert alert-success" role="alert" style="text-align: center;">
                  <?php 
                    if(isset($_GET['infov'])){
                        echo $_GET['infov'];
              ...
              <form method="POST" action="peniaDelEstudainteEntradasBD.php">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="inputEmail4" placeholder="" name="cantDeLaEntrada">
                    </div>
                  </div>
                  <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control" id="inputCity" name="precioDeLaEntradaU" >
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4">
              ...
              <?php } ?>
              <form method="POST" action="peniaDelEstudainteEntradasEliminarBD.php">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input type="number" class="form-control" id="inputEmail4" placeholder="" name="idDeLaEntradaAEliminar">
                    </div>
                  </div>
                </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
                Entradas 
                <a target="_Blank" href="vendor/fpdf/scripts/reporteTipoX.php" role="button">
                 ...
                 <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php  
                      ...
                      $query= $conexion->prepare('select * from bdunertest.t_penia_del_estudiante_entradasv ORDER BY t_penia_del_estudiante_entradasv.diaVendida desc');
                      $query->execute();
